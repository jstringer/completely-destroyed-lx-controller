...
- ⏭ **Next:** **Phase S** (owner-requested design-language test bed — build + exercise the widget vocabulary in a sandbox) → **Phase E** (the UI, with C3/C4/C5 + B1 folded in, consuming Phase-S helpers). E is the largest chunk.
